...
* Added support for Curly, Dotted and Dashed underlines.  See [this documentation](faq.html) on the escape sequences how enable undercurl support in vim and nvim. [#415](https://github.com/wez/wezterm/issues/415)
